...
const ProfessionnelsPage = () => {
    ...
    query {
      ...
      priseSon: file(relativePath: { eq: "assets/images/prise-de-son.jpg" }) {
        childImageSharp {
          fixed(width: 270, height: 270, quality: 90) {
            ...GatsbyImageSharpFixed
          }
      ...
      priseSonFull: file(relativePath: { eq: "assets/images/prise-de-son.jpg" }) {
        childImageSharp {
          resize(width: 2200, height: 2200, fit: CONTAIN, quality: 90) {
            src
          }
      ...
      montageVideo: file(relativePath: { eq: "assets/images/montage-video.jpg" }) {
        childImageSharp {
          fixed(width: 270, height: 270, quality: 90, cropFocus: CENTER) {
            ...GatsbyImageSharpFixed
          }
        }
      }
      montageVideoFull: file(relativePath: { eq: "assets/images/montage-video.jpg" }) {
        childImageSharp {
          resize(width: 2200, height: 2200, fit: CONTAIN, quality: 90) {
            src
          }
      ...
      mixageMastering: file(relativePath: { eq: "assets/images/mixage-mastering.jpg" }) {
        childImageSharp {
          fixed(width: 270, height: 270, quality: 90, cropFocus: CENTER) {
            ...GatsbyImageSharpFixed
          }
      ...
      mixageMasteringFull: file(relativePath: { eq: "assets/images/mixage-mastering.jpg" }) {
        childImageSharp {
          resize(width: 2200, height: 2200, fit: CONTAIN, quality: 90) {
            src
          }
      ...
      etalonnage: file(relativePath: { eq: "assets/images/etalonnage.jpg" }) {
        childImageSharp {
          fixed(width: 270, height: 270, quality: 90) {
            ...GatsbyImageSharpFixed
          }
      ...
      etalonnageFull: file(relativePath: { eq: "assets/images/etalonnage.jpg" }) {
        childImageSharp {
          resize(width: 2200, height: 2200, fit: CONTAIN, quality: 90) {
            src
          }
        ...
        <>
          ...
          />*/}
            ...
            <div id="savoir-faire" className={`${s.knowHow} container`}>
                <h2>Détail de nos prestations</h2>
                ...
                <div id={s.knowHowBoxes}>
                    <div className={s.knowHowBoxRow}>
                        ...
                        <div id={s.audiograph} className={s.knowHowBox}>
                            <div className={s.knowHowBoxInner}>
                                <div className={s.front}>
                                    <svg viewBox="0 0 128 122" xmlns="http://www.w3.org/2000/svg"><path d="M0 67.373h9.078V54.627H0v12.746zm11.801 20.94h9.078V32.776h-9.078v55.537zm11.802 16.388h9.078V16.388h-9.078v88.313zM35.404 122h9.078V0h-9.078v122zm23.603-41.88h9.078V40.97h-9.078v39.15zm12.71 8.193h9.077V33.687h-9.078v54.626zm11.8-4.552h9.079V38.24h-9.078V83.76zm11.802-9.104h9.078V46.433H95.32v28.224zm11.802-6.373h9.078V52.806h-9.078v15.478zm11.801-13.657v12.746H128V54.627h-9.078zM47.206 104.7h9.078V16.388h-9.078v88.313z" fillRule="nonzero" /></svg>
                                    <h4>Mixage & Mastering</h4>
                                </div>
                                <div className={s.back}>
                                    <a href={images.mixageMasteringFull.childImageSharp.resize.src} target="_blank">
                                        <Img
                                            fixed={images.mixageMastering.childImageSharp.fixed}
                                            alt="Homme filmant un homme assis, en train de parler"
                                        />
                                    </a>
                                </div>
                    ...
                    <p id={s.stuffUsed}>
                        ...
                        <br /><strong>Objectifs :</strong> Leica panasonic 18-55mm , Fuji XF 18-55mm
                        <br /><strong>Stabilisateur :</strong> Ronin SC2
                        <br /><br />
                        <strong>Micros :</strong> Zoom H4n Pro, Zoom H2, Shure SM58, Shure SM57, AT 2020, Sennheiser ME 2-II, AKG C214, Rode NTG4+
                        <br /><br />
            ...
            <div id="devis" className={s.devis}>
                <h2>Votre Devis</h2>

                <div className={s.devisContent}>
                    <div className={s.devisImage}>
                        <Img
                            fluid={{
                                ...images.votreDevis.childImageSharp.fluid,
