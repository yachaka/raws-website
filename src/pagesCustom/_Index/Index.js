...
const IndexPage = () => {
  const images = useStaticQuery(graphql`
    query {
      ...
      accueilPro: file(relativePath: { eq: "assets/images/accueil-professionels.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 2200, quality: 90) {
            ...GatsbyImageSharpFluid
          }
    ...
    <>
      ...
      <div id="clip-musical" className={`${s.musicalVideo} container`}>
        ...
        <div id={s.musicalVideoInfos}>
          ...
          <p>
            Les artistes sont libres de décider où ils souhaitent tourner leurs sessions, pour trouver ensemble la vision la mieux adaptée à leur univers.
          </p>
